...
final class WebPixels extends Pixels {
    ...
    protected void _copyPixels(Buffer dst, Buffer src, int size) {
        throw new RuntimeException ("[JVERR] _copyPixels not implemented");
    }

    @Override
    protected void _attachInt(long ptr, int w, int h, IntBuffer ints, int[] array, int offset) {
        throw new RuntimeException ("[JVERR] _attachInt not implemented");
    }

    @Override
    protected void _attachByte(long ptr, int w, int h, ByteBuffer bytes, byte[] array, int offset) {
        throw new RuntimeException ("[JVERR] _attachByte not implemented");
    }
