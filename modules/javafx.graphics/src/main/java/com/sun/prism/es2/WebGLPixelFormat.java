...
class WebGLPixelFormat extends GLPixelFormat {

    private static long nCreatePixelFormat(long nativeScreen, int[] attrArr) {
System.out.println("[WEBGLPIXELFORMAT]");
return 1;
}

    WebGLPixelFormat(long nativeScreen, Attributes attrs) {
